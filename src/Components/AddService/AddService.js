...
const AddService = () => {
  ...
  useEffect(() => {
    document.title = "SEAKERS Add Tour";
  }, []);
  ...
  return (
    <div className="container">
      ...
      <h5 className="admin-warn">
        *Read below list carefully before starting the form fill up
      </h5>
      ...
      <ul className="text-start">
        ...
        <li>
          If you put irrelevant data our admin panel can change or delete your
          tour without notice
        </li>
        <li>Please use hosted image url we do not allow copyright images</li>
        <li>
          Once you have added all these you can see the card of your tour on
          home page click there to place your order
        </li>
        <li>You can not change or modify after adding the tour</li>
        <li>Please contact with us to update or modify your trip</li>
        <li>
          Your given package fee can be changed or modified. We will let you
          know
        </li>
      </ul>
